...
if __name__ == "__main__": 
    ...
    """
    hdf_filename = '/qfs/people/feng779/PYTHON/ML/PINN_SVE/HEC-RAS/case5/MixedFlow.p02.hdf'
    ...
    weight_path = 'log/case5/weights.out'
    # Training
    ...
    saved_path = 'saved_model/case5_mff/PINN_SVE.pickle'
    weight_path = 'log/case5_mff/weights.out'
    wmff_path = 'saved_model/case5_mff/w_mff.out'
    # Training
    ...
    plt.tight_layout()
    plt.savefig('figures/case5/contour_h.png')
    plt.close()
    ...
    for k in range(len(tlist)):
        axes[k].plot(x, h_test[tlist[k],:]+eles, '-k', linewidth=2, label='reference')
    ...
    plt.tight_layout()
    plt.savefig('figures/case5/along_channel_h.png')
    plt.close()
